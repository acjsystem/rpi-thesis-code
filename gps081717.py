...
try:
	...
	def gps_func():
		...
		if loc == "Location Not Fix":
					...
					mes = (loc) #Content of the text from module to owner, there is str before latitude and longitude because variable latitude and longitude should be concatenated to from "Float" to "String" type 
